...
@wrap_experiment(log_dir = './experiments/Pendulum/MaxTRPO')
def Max_TRPO_P(ctxt=None, seed=1):
    """Trust Region Policy Optimization 
    Train a single agent maximizing its own 
...
@wrap_experiment(log_dir = './experiments/Pendulum/curriculum')
def curriculum_student_teacher_P(ctxt=None, seed=1):
    """
    Student-teacher setup for auto-curricula using both teacher and student surprise 
    Pendulum environment
    """
...
#curriculum_student_teacher_P(seed = 1)
#curriculum_student_teacher_P(seed = 2)
#curriculum_student_teacher_P(seed = 3)
...
########################################################################################
#Cartpole 
@wrap_experiment(log_dir = './experiments/CartPole/MaxTRPO')
...
from garage.experiment import Snapshotter
snapshotter = Snapshotter()
data = snapshotter.load('./experiments/CartPole/MaxTRPO_23')
policy = data['algo'].policy
