...
class Trainer:
    ...
    def setup(self, algo, env, student_env=None):
    ...
    def get_student_env_copy(self):
        ...
        """
        if self._student_env:
            return cloudpickle.loads(cloudpickle.dumps(self._student_env))
        else:
            return None
